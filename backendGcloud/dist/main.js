...
async function ai(request, response) {
  ...
  const {
    question,
    context
  } = request.body; //Get URL-encoded data
...
/* harmony export */ });
/* harmony import */ var dotenv__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dotenv */ "./node_modules/.pnpm/dotenv@16.5.0/node_modules/dotenv/lib/main.js");
...
const port = process.env.PORT; //Common backend ports are 3000, 8080, 9000.

const app = express__WEBPACK_IMPORTED_MODULE_0___default()(); //Instantiate an express.js object.
app.use(cors__WEBPACK_IMPORTED_MODULE_1___default()()); //Allows communcation with the frontend.
app.use((0,express__WEBPACK_IMPORTED_MODULE_0__.urlencoded)()); //Allows data to be received from Postman through x-www-form-urlencoded.
app.use((0,express__WEBPACK_IMPORTED_MODULE_0__.json)()); //Configures Express to receive JSON parameters from Axios. 
